...
namespace DataService.Data.Migrations
{
    ...
    [Migration("20210421151642_ShopCollectionProductIdIssueFixed")]
    partial class ShopCollectionProductIdIssueFixed
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataService.Data.Entities.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DataService.Data.Entities.OrderList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DataService.Data.Entities.OrderItem", b =>
                {
                    b.HasOne("DataService.Data.Entities.OrderList", "OrderList")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("DataService.Data.Entities.ProductReview", b =>
                {
                    b.HasOne("DataService.Data.Entities.Product", null)
                        .WithMany("Reviews")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
